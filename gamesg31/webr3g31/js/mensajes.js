...
let url="http://192.18.146.240:8083/api/Message/all"
...
function editar(id) {
    ...
    url = "http://192.18.146.240:8083/api/Message"
...
function eliminar(id) {
    let url = "http://192.18.146.240:8083/api/Message"
...
function guardarNuevo() {
    ...
    url = "http://192.18.146.240:8083/api/Message/save";
...
function guardarBorrar() {
    let url = "http://192.18.146.240:8083/api/Message/delete"
...
function traerdatos() {
    let registros = ""
    let id = ""
    url="http://192.18.146.240:8083/api/Message/all"
...
function traeclientes(){
    //1 crear un objeto XMLHttpRequest
    let peticion = new XMLHttpRequest();
    url = "http://192.18.146.240:8083/api/Client/all";
    let id;
    let nombre;
    let respuesta;
    /*2 propiedad onreadystatechange asigna a una funcion
